...
public class TestOrderBy
{
    ...
    public void OrderBy()
    {
        ...
        var vars = new (string[], IEnumerable<object?>)[] {
            ...
            (["Objs.Count()"], items.OrderBy(x => x?.Objs?.Count()).ToList()),
            ([">Objs.Any()"], items.OrderByDescending(x => x?.Objs?.Any()).ToList()),
            (["Objs.Sum(Num1)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num1)).ToList()),
            (["Objs.Sum(Num2)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num2)).ToList()),
            (["Objs.Sum(Num3)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num3)).ToList()),
            (["Objs.Sum(Num4)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num4)).ToList()),
            (["Objs.Sum(Num5)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num5)).ToList()),
            (["Objs.Sum(Num6)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num6)).ToList()),
            (["Objs.Sum(Num7)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num7)).ToList()),
            (["Objs.Sum(Num8)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num8)).ToList()),
            (["Objs.Sum(Num9)"], items.OrderBy(x => x?.Objs?.Sum(xx => xx?.Num9)).ToList()),
            (["Objs.Average(Num1)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num1)).ToList()),
            (["Objs.Average(Num2)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num2)).ToList()),
            (["Objs.Average(Num3)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num3)).ToList()),
            (["Objs.Average(Num4)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num4)).ToList()),
            (["Objs.Average(Num5)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num5)).ToList()),
            (["Objs.Average(Num6)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num6)).ToList()),
            (["Objs.Average(Num7)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num7)).ToList()),
            (["Objs.Average(Num8)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num8)).ToList()),
            (["Objs.Average(Num9)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Average(xx => xx?.Num9)).ToList()),
            (["Objs.Min(Date1)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Min(xx => xx?.Date1)).ToList()),
            (["Objs.Max(Date2)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Max(xx => xx?.Date2)).ToList()),
            (["Objs.Min(Obj.Prop4)"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Min(xx => xx?.Obj?.Prop4)).ToList()),
            (["Objs.Max(Objs.Sum(Prop5))"], items.OrderBy(x => x?.Objs?.Any() != true ? null : x?.Objs?.Max(xx => xx?.Objs?.Sum(xxx=>xxx.Prop5))).ToList()),
        };
